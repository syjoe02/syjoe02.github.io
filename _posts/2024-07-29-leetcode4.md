...
1. Place two pointers, left and right, at the ends of the array. <br>(Two-Pointer Technique)<br>
    Initialize left_max, right_max, and water to 0.

2. Repeat while the condition left < right is satisfied:

    a. When `height[left] <= height[right]`: <br>
...
3. Repeat until the left and right pointers meet.<br>
